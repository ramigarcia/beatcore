...
if (isset($_POST["btn_editar"])) {
  ...
  if ($_FILES["foto_perfil"]["name"] == "") {
    ...
    $carpeta_destino_foto_p = $_SERVER['DOCUMENT_ROOT'] . '/BeatCore/publico/img/foto_perfil/' . $id_usuario . '/';
    if (!file_exists($carpeta_destino_foto_p)) {
      mkdir($carpeta_destino_foto_p);
    }
    move_uploaded_file($_FILES['foto_perfil']['tmp_name'], $carpeta_destino_foto_p . $foto_perfil);
  }
